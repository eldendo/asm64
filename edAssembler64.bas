...
6440 if sy$="#" then 6600:rem immediate
6450 if sy$="num" or sy$="label" then 6700: rem direct
6460 if sy$="(" then 6800:rem indirect
6470 if sy$="a" then gosub 5800:mm$="accumulator":print mm$:return
6475 print mm$:stop
...
9799 rem  mnem   imm acc zp  zpx zpy abs abx aby ind inx iny imp rel
