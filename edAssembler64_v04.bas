...
6300 rem *** labeldef ***
6310 rem print "labeldef found: ";name$;" <-";lc
...
6700 rem ** direct **
6710 mm=5
6720 gosub 7000:rem print num:rem value
...
7110 rem print "emit at";lc;" ";mn$(mn);" ";mm$(mm);by(mm);"byte(s)"
7120 hi=int(num/256):lo=num-hi*256
7130 poke lc,ta(mn,mm):rem print ta(mn,mm);
7140 if by(mm)>1 then poke lc+1,lo:rem print lo;
7150 if by(mm)>2 then poke lc+2,hi:rem print hi;"(=";num;")"
7151 rem print
7160 lc=lc+by(mm)
7170 return
